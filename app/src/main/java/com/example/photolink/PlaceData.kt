...
object PlaceData {
    ...
    fun getRow() = listOf(
            ...
            Row(4, "Улица 4", "Описание 3", false),
            Row(5, "Улица 5", "Описание 3", false),
            Row(6, "Улица 6", "Описание 3", false),
            Row(7, "Улица 7", "Описание 3", false),
            Row(8, "Улица 8", "Описание 3", false),
            Row(9, "Улица 9", "Описание 3", false),
            Row(10, "Улица 10", "Описание 3", false),
            Row(11, "Улица 11", "Описание 3", false),
            Row(12, "Улица 12", "Описание 3", false),
            Row(13, "Улица 13", "Описание 3", false),
            Row(14, "Улица 14", "Описание 3", false),
            Row(15, "Улица 15", "Описание 3", false)
